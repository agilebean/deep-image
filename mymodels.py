from keras.applications import vgg16, vgg19, resnet50, inception_v3, xception, \
                               mobilenet, mobilenet_v2, nasnet, densenet, inception_resnet_v2
...
model_data = {
    ...
    'MobileNet': {
        'gs_bucket_label' : 'gc_mobilenet',
        'image_size' : 224, 'top1_acc' : 70.6, 'top5_acc' : 87.1,
    ...
    'MobileNetV2': {
        'gs_bucket_label' : 'gc_mobilenet_v2',
        'image_size' : 224, 'top1_acc' : 71.8, 'top5_acc' : 91.0,
    ...
    'NASNetMobile': {
        'gs_bucket_label' : 'gc_nasnet_mobile',
        'image_size' : 224, 'top1_acc' : 74.0, 'top5_acc' : 91.6,
        'model_preprocess_input': nasnet.preprocess_input,
        'model_decode_predictions': nasnet.decode_predictions
    },
    'DenseNet201': {
        'gs_bucket_label' : 'densenet201',
        'image_size' : 224, 'top1_acc' : 77.0, 'top5_acc' : 93.3,
        'model_preprocess_input': densenet.preprocess_input,
        'model_decode_predictions': densenet.decode_predictions
    },
    'InceptionResNetV2': {
        'gs_bucket_label' : 'inception_resnet_v2',
        'image_size' : 299, 'top1_acc' : 80.1, 'top5_acc' : 95.1,
...
# Append all loaded model instances into model data dict of dicts
